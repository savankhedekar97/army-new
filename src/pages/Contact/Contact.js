      ...
      <div className="contact-overlay">
        <div className="contact-container animate-contact">
          ...
          <div className="info-card">
            <h3>Address</h3>
            <p>
              Corps of Engineers Sailing Club (CESC),<br />
              F Combat, College of Military Engineering (CME),<br />
              Dapodi, Pune – 411031, Maharashtra
            </p>
          </div>
          ...
          <div className="info-card">
            <h3>Emails</h3>
            <p>
              noaiopti@rediffmail.com<br />
              noairegatta@gmail.com
            </p>
          </div>
